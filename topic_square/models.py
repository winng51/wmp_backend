...
class User(models.Model):
    ...
    wechat_id = models.CharField(max_length=15, verbose_name="微信id")
    avatar = models.ImageField(default=None, upload_to='avatar', verbose_name="用户头像")
    grade = models.CharField(max_length=4, default=2019, verbose_name="年级")
    college = models.CharField(max_length=2, default='SW', choices=COLLEGE_CHOICES, verbose_name="学院")
